...
function AddClauseModalBody({ closeModal }) {
  ...
  const AddArticle = async () => {
    ...
    const response = await axios.post("/clause/createClause", newArticleObject);
  ...
  return (
    <>
      <InputText
        type="text"
        defaultValue={leadObj.ClauseTitle}
...
export default AddClauseModalBody;
